                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="fieldValue">
                        ...
                        AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="CountryName" DataValueField="CountryID">
                          <asp:ListItem Value="0">Select</asp:ListItem>
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:meis007ConnectionString %>" 
                        SelectCommand="SELECT [CountryID], [CountryName] FROM [CountryMaster]">
                        </asp:SqlDataSource>
                        <asp:RequiredFieldValidator ID="rfvCountry" runat="server" ControlToValidate="ddlCountry" ForeColor="#FF3300" 
                    ...
                    <tr>
                      ...
                      <td class="fieldValue">
                        ...
                        DataSourceID="SqlDataSource2" DataTextField="CityName" DataValueField="CityID" EnableViewState="False">
                          <asp:ListItem Value="0">Select</asp:ListItem>
                        </asp:DropDownList>
                        ...
                        <asp:RequiredFieldValidator ID="rfvCity" runat="server" ControlToValidate="ddlCity" ForeColor="#FF3300" 
                        SetFocusOnError="True" InitialValue="0">*</asp:RequiredFieldValidator>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="fieldValue">
                        <asp:TextBox ID="txtPickupDate" runat="server" CssClass="start-date">
                        </asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvPickupDate" runat="server" ControlToValidate="txtPickupDate" ForeColor="#FF3300" 
                    ...
                    <tr>
                      ...
                      <td class="fieldValue">
                        ...
                        <asp:RequiredFieldValidator ID="rfvDropoffDate" runat="server" ControlToValidate="txtDropoffDate" ForeColor="#FF3300" 
                        SetFocusOnError="True" >*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                      ...
                      <td class="fieldValue">
                        ...
                        <asp:RequiredFieldValidator ID="rfvCarType" runat="server" ControlToValidate="ddlCarType" ForeColor="#FF3300" 
                        SetFocusOnError="True" InitialValue="0">*</asp:RequiredFieldValidator>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="fieldValue">
                        <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-success margion10" onclick="btnSearch_Click"/>
                      </td>
                    </tr>
                  </tbody>
                </table>
